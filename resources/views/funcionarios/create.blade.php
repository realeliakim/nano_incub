        ...
        <form id="form" method="POST" action="{{ route('funcionarios.store') }}">
          ...
          <div class="form-group row mb-3">
            <div class="col-md-12 mb-3">
              ...
              <input id="name" type="text" class="form-control" name="nome" placeholder="Nome" value="" required autocomplete="" autofocus>
            </div>
          </div>
          ...
          <div class="form-group row mb-3">
            ...
            <div class="col-md-6 mb-3">
              ...
              <input id="senha" type="password" class="form-control" name="senha" placeholder="" value="" required autocomplete="" autofocus>
            </div>
          </div>
          ...
          <div class="form-group row mb-3">
            <div class="col-md-5 mb-3">
              ...
              <input id="saldo" type="text" class="form-control" name="saldo" placeholder="" value="" required autocomplete="" autofocus>
            </div>
